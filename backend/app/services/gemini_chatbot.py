"""
Module for a z.ai-powered chatbot assistant.
...
Return your response as a JSON object with a "text" field containing your message.
"""
...
def get_contextual_chatbot_response(user_message: str, db: Session, user_id: int) -> str:
    ...
    result = call_ai(messages, "chatbot", db, user_id, ChatResponse)
